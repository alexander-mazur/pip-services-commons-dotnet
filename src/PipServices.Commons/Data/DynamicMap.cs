...
namespace PipServices.Commons.Data
{
    public class DynamicMap : Dictionary<string, object>
    {
        ...
        {
            var value = Get(path);
            return RecursiveMapConverter.ToNullableMap(value) ?? new DynamicMap();
        }

        public DynamicMap GetMapWithDefault(string path, DynamicMap defaultValue = null)
        {
            var value = Get(path);
            return RecursiveMapConverter.ToMapWithDefault(value, defaultValue);
        }
        ...
        public void SetTuplesArray(object[] values)
        {
            for (var i = 0; i < values.Length; i += 2)
            {
                ...
                var path = StringConverter.ToString(values[i]);
        ...
        public void AssignTo(object value)
        {
            ...
            var props = System.ComponentModel.TypeDescriptor.GetProperties(value);
        ...
        {
            return RecursiveMapConverter.ToMap(value);
        }
